            ...
            steps {
                script {
                    ...
                    if (env.DUX_MAJOR_VERSION.toInteger() >= 3) {
                        echo "Dux version is 3 or higher. Running 'dux pacreader destroy'..."
                        command = params.HOST_IP == 'All' ? 'dux pacreader destroy -y' : "dux pacreader destroy -y -p ${params.HOST_IP}"
                    } else {
